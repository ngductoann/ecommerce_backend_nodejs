 ...
 * HTTP Status Codes
 *
 * This module exports an object containing all standard HTTP status codes
 * with their respective numeric values. These codes are used to indicate
 ...
 * @module statusCodes
 */
// full http status code module export
module.exports = {
  // 1xx: Informational responses
  ...
  RESET_CONTENT: 205, // The server successfully processed the request, but requires the requester to reset the document view.
  PARTIAL_CONTENT: 206, // The server is delivering only part of the resource due to a range header sent by the client.
  MULTI_STATUS: 207, // The message body that follows is an XML message and can contain multiple separate response codes (WebDAV).
  ALREADY_REPORTED: 208, // The members of a DAV binding have already been enumerated in a previous reply to this request (WebDAV).
  ...
  IM_A_TEAPOT: 418, // This code was defined in 1998 as one of the traditional IETF April Fools' jokes.
